    ...
    <Container>
      <form className="new-inventory">
        ...
        <input
          ...
          id="officer"
          name="officer"
          onChange={(e) => setInventory({ ...inventory, officer: e.target.value })}
        ...
        >
          <option name="beverages" disabled>-- Beverages --</option>
          ...
          <option name="beverages" disabled>-- Dairy --</option>
          ...
          <option name="meat" disabled>-- Meat --</option>
          ...
          <option name="toileteries" disabled>-- Toileteries --</option>
        ...
        <input
          ...
          id="batch-units"
          name="batchUnits"
          onChange={(e) => setInventory({ ...inventory, batchUnits: e.target.value })}
        ...
        <input
          ...
          id="product-image"
          name="productImage"
          onChange={(e) => setInventory({ ...inventory, productImage: e.target.value })}
